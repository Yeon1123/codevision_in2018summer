...
; 0000 000F led = 0x01;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0010 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0); //0,1,2는 출력(led)
	LDI  R30,LOW(7)
	OUT  0x1A,R30
; 0000 0011 PORTA = led; //첫번째 led를 켠다.
	OUT  0x1B,R5
; 0000 0012 
; 0000 0013     while (1)
_0x3:
; 0000 0014       {
; 0000 0015        if(PINA.3 == 0){
	SBIC 0x19,3
	RJMP _0x6
; 0000 0016 
; 0000 0017             led = led <<1;
	LSL  R5
; 0000 0018             led = led & 0x0F;
	LDI  R30,LOW(15)
	AND  R5,R30
; 0000 0019 
; 0000 001A                   if(led == 0x08){
	LDI  R30,LOW(8)
	CP   R30,R5
	BRNE _0x7
; 0000 001B                         led = 0x01;
