...
; 0000 0082 // Clock value: 2000.000 kHz
; 0000 0083 // Mode: CTC top=ICR1
...
; 0000 0089 // Timer Period: 0.5 us
; 0000 008A // Timer1 Overflow Interrupt: On
; 0000 008B // Input Capture Interrupt: Off
; 0000 008C // Compare A Match Interrupt: On
...
; 0000 008F TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 0090 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (1<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (0<<CS10);
	LDI  R30,LOW(26)
	OUT  0x2E,R30
...
; 0000 00C1 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(20)
	OUT  0x37,R30
...
; 0000 00E3 // ADC disabled
; 0000 00E4 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00E5 
; 0000 00E6 // SPI initialization
; 0000 00E7 // SPI disabled
; 0000 00E8 SPCR=(0<<SPIE) | (0<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	OUT  0xD,R30
; 0000 00E9 
; 0000 00EA // TWI initialization
; 0000 00EB // TWI disabled
; 0000 00EC TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	STS  116,R30
; 0000 00ED 
