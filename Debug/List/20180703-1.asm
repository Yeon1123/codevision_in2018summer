...
; 0000 0032 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(7)
	OUT  0x1A,R30
; 0000 0033 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0034 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	OUT  0x1B,R30
; 0000 0035 
...
; 0000 004A DDRE=(0<<DDE7) | (0<<DDE6) | (0<<DDE5) | (0<<DDE4) | (0<<DDE3) | (0<<DDE2) | (0<<DDE1) | (0<<DDE0);
	OUT  0x2,R30
; 0000 004B // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 004C PORTE=(0<<PORTE7) | (0<<PORTE6) | (0<<PORTE5) | (0<<PORTE4) | (0<<PORTE3) | (0<<PORTE2) | (0<<PORTE1) | (0<<PORTE0);
	OUT  0x3,R30
; 0000 004D 
; 0000 004E // Port F initialization
; 0000 004F // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0050 DDRF=(0<<DDF7) | (0<<DDF6) | (0<<DDF5) | (0<<DDF4) | (0<<DDF3) | (0<<DDF2) | (0<<DDF1) | (0<<DDF0);
	STS  97,R30
; 0000 0051 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0052 PORTF=(0<<PORTF7) | (0<<PORTF6) | (0<<PORTF5) | (0<<PORTF4) | (0<<PORTF3) | (0<<PORTF2) | (0<<PORTF1) | (0<<PORTF0);
	STS  98,R30
; 0000 0053 
; 0000 0054 // Port G initialization
; 0000 0055 // Function: Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0056 DDRG=(0<<DDG4) | (0<<DDG3) | (0<<DDG2) | (0<<DDG1) | (0<<DDG0);
	STS  100,R30
; 0000 0057 // State: Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0058 PORTG=(0<<PORTG4) | (0<<PORTG3) | (0<<PORTG2) | (0<<PORTG1) | (0<<PORTG0);
	STS  101,R30
; 0000 0059 
; 0000 005A // Timer/Counter 0 initialization
; 0000 005B // Clock source: System Clock
; 0000 005C // Clock value: 2000.000 kHz
; 0000 005D // Mode: Fast PWM top=0xFF
; 0000 005E // OC0 output: Disconnected
; 0000 005F // Timer Period: 0.128 ms
; 0000 0060 ASSR=0<<AS0;
	OUT  0x30,R30
; 0000 0061 TCCR0=(1<<WGM00) | (0<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(74)
	OUT  0x33,R30
...
; 0000 006B // OC1C output: Disconnected
...
; 0000 0072 // Compare C Match Interrupt: Off
; 0000 0073 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
...
; 0000 007C OCR1BL=0x00;
	OUT  0x28,R30
; 0000 007D OCR1CH=0x00;
	STS  121,R30
; 0000 007E OCR1CL=0x00;
	STS  120,R30
; 0000 007F 
...
; 0000 0087 OCR2=0x00;
	OUT  0x23,R30
; 0000 0088 
; 0000 0089 // Timer/Counter 3 initialization
; 0000 008A // Clock source: System Clock
; 0000 008B // Clock value: Timer3 Stopped
; 0000 008C // Mode: Normal top=0xFFFF
; 0000 008D // OC3A output: Disconnected
; 0000 008E // OC3B output: Disconnected
; 0000 008F // OC3C output: Disconnected
; 0000 0090 // Noise Canceler: Off
; 0000 0091 // Input Capture on Falling Edge
; 0000 0092 // Timer3 Overflow Interrupt: Off
; 0000 0093 // Input Capture Interrupt: Off
; 0000 0094 // Compare A Match Interrupt: Off
; 0000 0095 // Compare B Match Interrupt: Off
; 0000 0096 // Compare C Match Interrupt: Off
; 0000 0097 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 0098 TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 0099 TCNT3H=0x00;
	STS  137,R30
; 0000 009A TCNT3L=0x00;
	STS  136,R30
; 0000 009B ICR3H=0x00;
	STS  129,R30
; 0000 009C ICR3L=0x00;
	STS  128,R30
; 0000 009D OCR3AH=0x00;
	STS  135,R30
; 0000 009E OCR3AL=0x00;
	STS  134,R30
; 0000 009F OCR3BH=0x00;
	STS  133,R30
; 0000 00A0 OCR3BL=0x00;
	STS  132,R30
; 0000 00A1 OCR3CH=0x00;
	STS  131,R30
; 0000 00A2 OCR3CL=0x00;
	STS  130,R30
; 0000 00A3 
; 0000 00A4 // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 00A5 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(3)
	OUT  0x37,R30
; 0000 00A6 ETIMSK=(0<<TICIE3) | (0<<OCIE3A) | (0<<OCIE3B) | (0<<TOIE3) | (0<<OCIE3C) | (0<<OCIE1C);
	LDI  R30,LOW(0)
	STS  125,R30
; 0000 00A7 
...
; 0000 00AF // INT6: Off
; 0000 00B0 // INT7: Off
; 0000 00B1 EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 00B2 EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00B3 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 00B4 
; 0000 00B5 // USART0 initialization
; 0000 00B6 // USART0 disabled
; 0000 00B7 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	OUT  0xA,R30
; 0000 00B8 
; 0000 00B9 // USART1 initialization
; 0000 00BA // USART1 disabled
; 0000 00BB UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  154,R30
; 0000 00BC 
...
; 0000 00C8 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00C9 
