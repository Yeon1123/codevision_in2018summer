...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
;*******************************************************/
;
;#include <mega128.h> // Alphanumeric LCD Module functions
...
; 0000 0044 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 006A // OC1C output: Disconnected
...
; 0000 0071 // Compare C Match Interrupt: Off
; 0000 0072 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
...
; 0000 007B OCR1BL=0x00;
	OUT  0x28,R30
; 0000 007C OCR1CH=0x00;
	STS  121,R30
; 0000 007D OCR1CL=0x00;
	STS  120,R30
; 0000 007E 
...
; 0000 0086 OCR2=0x00;
	OUT  0x23,R30
; 0000 0087 
; 0000 0088 // Timer/Counter 3 initialization
; 0000 0089 // Clock source: System Clock
; 0000 008A // Clock value: Timer3 Stopped
; 0000 008B // Mode: Normal top=0xFFFF
; 0000 008C // OC3A output: Disconnected
; 0000 008D // OC3B output: Disconnected
; 0000 008E // OC3C output: Disconnected
; 0000 008F // Noise Canceler: Off
; 0000 0090 // Input Capture on Falling Edge
; 0000 0091 // Timer3 Overflow Interrupt: Off
...
; 0000 0096 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 0097 TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 0098 TCNT3H=0x00;
	STS  137,R30
; 0000 0099 TCNT3L=0x00;
	STS  136,R30
; 0000 009A ICR3H=0x00;
	STS  129,R30
; 0000 009B ICR3L=0x00;
	STS  128,R30
; 0000 009C OCR3AH=0x00;
	STS  135,R30
; 0000 009D OCR3AL=0x00;
	STS  134,R30
; 0000 009E OCR3BH=0x00;
	STS  133,R30
; 0000 009F OCR3BL=0x00;
	STS  132,R30
; 0000 00A0 OCR3CH=0x00;
	STS  131,R30
; 0000 00A1 OCR3CL=0x00;
	STS  130,R30
; 0000 00A2 
; 0000 00A3 // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 00A4 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x37,R30
; 0000 00A5 ETIMSK=(0<<TICIE3) | (0<<OCIE3A) | (0<<OCIE3B) | (0<<TOIE3) | (0<<OCIE3C) | (0<<OCIE1C);
	STS  125,R30
; 0000 00A6 
...
; 0000 00AE // INT6: Off
; 0000 00AF // INT7: Off
; 0000 00B0 EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 00B1 EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00B2 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 00B3 
; 0000 00B4 // USART0 initialization
; 0000 00B5 // USART0 disabled
...
; 0000 00D4 // RS - PORTD Bit 0
; 0000 00D5 // RD - PORTD Bit 1
; 0000 00D6 // EN - PORTD Bit 2
; 0000 00D7 // D4 - PORTD Bit 4
; 0000 00D8 // D5 - PORTD Bit 5
; 0000 00D9 // D6 - PORTD Bit 6
; 0000 00DA // D7 - PORTD Bit 7
; 0000 00DB // Characters/line: 8
; 0000 00DC lcd_init(8);
	LDI  R26,LOW(8)
	CALL _lcd_init
; 0000 00DD 
; 0000 00DE while (1)
