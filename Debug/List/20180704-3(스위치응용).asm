...
; 0000 0018 initial();
	RCALL _initial
; 0000 0019 
; 0000 001A DDRA.0 = 1;  //portA Ãâ·Â ¼³Á¤
	SBI  0x1A,0
; 0000 001B DDRA.1 = 1;
	SBI  0x1A,1
; 0000 001C DDRA.2 = 1;
...
_0x10:
	OUT  0x1B,R4
; 0000 002E              delay_ms(500);//ÀÔ·Â ÈÄ µô·¹ÀÌ¸¦ Áà¼­ ¼Óµµ¸¦ ³·Ãß´Â ´À³¦.... ESCÅ° ³îÀÌ¸¦ »ý°¢ÇØº¾½Ã´Ù.
	LDI  R26,LOW(500)
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 002F 
...
_0x15:
	OUT  0x1B,R4
; 0000 003F              delay_ms(500);//ÀÔ·Â ÈÄ µô·¹ÀÌ¸¦ Áà¼­ ¼Óµµ¸¦ ³·Ãß´Â ´À³¦.... ESCÅ° ³îÀÌ¸¦ »ý°¢ÇØº¾½Ã´Ù.
	LDI  R26,LOW(500)
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 0040 
