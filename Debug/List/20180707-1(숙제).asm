...
; 0000 0018 
; 0000 0019 
; 0000 001A DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0); //0,1,2는 출력(led)
	LDI  R30,LOW(7)
	OUT  0x1A,R30
; 0000 001B 
; 0000 001C PORTA = led; //첫번째 led를 켠다.
	RCALL SUBOPT_0x0
	OUT  0x1B,R30
; 0000 001D 
; 0000 001E 
...
; 0000 0073 
; 0000 0074 PORTE=(0<<PORTE7) | (0<<PORTE6) | (0<<PORTE5) | (0<<PORTE4) | (0<<PORTE3) | (0<<PORTE2) | (0<<PORTE1) | (0<<PORTE0);
	OUT  0x3,R30
; 0000 0075 
; 0000 0076 
; 0000 0077 
...
; 0000 007F 
; 0000 0080 PORTF=(0<<PORTF7) | (0<<PORTF6) | (0<<PORTF5) | (0<<PORTF4) | (0<<PORTF3) | (0<<PORTF2) | (0<<PORTF1) | (0<<PORTF0);
	STS  98,R30
; 0000 0081 
; 0000 0082 
; 0000 0083 
; 0000 0084 // Port G initialization
; 0000 0085 
...
; 0000 008B 
; 0000 008C PORTG=(0<<PORTG4) | (0<<PORTG3) | (0<<PORTG2) | (0<<PORTG1) | (0<<PORTG0);
	STS  101,R30
; 0000 008D 
; 0000 008E 
; 0000 008F 
...
; 0000 00AF 
; 0000 00B0 // OC1C output: Disconnected
; 0000 00B1 
...
; 0000 00BD 
; 0000 00BE // Compare C Match Interrupt: Off
; 0000 00BF 
; 0000 00C0 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 00C1 
...
; 0000 00E1 
; 0000 00E2 // OC2 output: Disconnected
; 0000 00E3 
; 0000 00E4 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
; 0000 00E5 
...
; 0000 00EF 
; 0000 00F0 // Clock value: Timer3 Stopped
; 0000 00F1 
; 0000 00F2 // Mode: Normal top=0xFFFF
; 0000 00F3 
; 0000 00F4 // OC3A output: Disconnected
; 0000 00F5 
; 0000 00F6 // OC3B output: Disconnected
; 0000 00F7 
; 0000 00F8 // OC3C output: Disconnected
; 0000 00F9 
...
; 0000 0103 
; 0000 0104 // Compare B Match Interrupt: Off
; 0000 0105 
; 0000 0106 // Compare C Match Interrupt: Off
; 0000 0107 
; 0000 0108 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 0109 
; 0000 010A TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 010B 
; 0000 010C TCNT3H=0x00;
	STS  137,R30
; 0000 010D 
; 0000 010E TCNT3L=0x00;
	STS  136,R30
; 0000 010F 
...
; 0000 0123 
; 0000 0124 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x37,R30
; 0000 0125 
...
; 0000 0128 
; 0000 0129 
; 0000 012A // External Interrupt(s) initialization
; 0000 012B 
; 0000 012C // INT0: Off
; 0000 012D 
; 0000 012E // INT1: Off
...
; 0000 013A // INT7: Off
; 0000 013B 
; 0000 013C EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 013D 
; 0000 013E EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 013F 
; 0000 0140 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 0141 
; 0000 0142 
; 0000 0143 
; 0000 0144 // USART0 initialization
; 0000 0145 
; 0000 0146 // USART0 disabled
; 0000 0147 
; 0000 0148 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	OUT  0xA,R30
; 0000 0149 
; 0000 014A 
; 0000 014B 
; 0000 014C // USART1 initialization
; 0000 014D 
; 0000 014E // USART1 disabled
; 0000 014F 
; 0000 0150 UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  154,R30
; 0000 0151 
; 0000 0152 
; 0000 0153 
...
; 0000 015B 
; 0000 015C // The Analog Comparator's negative input is
; 0000 015D 
; 0000 015E // connected to the AIN1 pin
; 0000 015F 
; 0000 0160 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0161 
; 0000 0162 SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 0163 
; 0000 0164 
; 0000 0165 
; 0000 0166 // ADC initialization
; 0000 0167 
; 0000 0168 // ADC disabled
; 0000 0169 
; 0000 016A ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 016B 
; 0000 016C 
; 0000 016D 
; 0000 016E // SPI initialization
; 0000 016F 
