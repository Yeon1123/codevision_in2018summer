...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x21,0x0,0x77
	.DB  0x6F,0x72,0x6C,0x64,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0064 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
...
; 0000 007E // OC3A output: Disconnected
; 0000 007F // OC3B output: Disconnected
; 0000 0080 // OC3C output: Disconnected
...
; 0000 0088 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 0089 TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
...
; 0000 0096 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x37,R30
...
; 0000 00A0 // INT6: Off
; 0000 00A1 // INT7: Off
; 0000 00A2 EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 00A3 EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00A4 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 00A5 
; 0000 00A6 // USART0 initialization
; 0000 00A7 // USART0 disabled
; 0000 00A8 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	OUT  0xA,R30
; 0000 00A9 
; 0000 00AA // USART1 initialization
; 0000 00AB // USART1 disabled
; 0000 00AC UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  154,R30
; 0000 00AD 
...
; 0000 00C5 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:  0
; 0000 00C6 // RS - PORTD Bit 0
; 0000 00C7 // RD - PORTD Bit 1
; 0000 00C8 // EN - PORTD Bit 2
...
; 0000 00CF  lcd_clear();
	RCALL _lcd_clear
; 0000 00D0      lcd_gotoxy(2, 0);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00D1      lcd_putsf("Hello!");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00D2        lcd_gotoxy(2, 1);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00D3      lcd_putsf("world!");
	__POINTW2FN _0x0,7
	RCALL _lcd_putsf
; 0000 00D4 while (1)
_0x3:
; 0000 00D5       {
; 0000 00D6       // Place your code here
; 0000 00D7 
; 0000 00D8       }
	RJMP _0x3
; 0000 00D9 }
