...
ICR1 = 255; //high(최대값) TOP  ->밝아지는 시간을 조정할 수 ㅣㅇㅆ다. TCNT는 1씩 오르니까!
OCR1A = 255;
...
while (1)
 ...
 //    ICR1 = 1000; //high(최대값) TOP  ->밝아지는 시간을 조정할 수 ㅣㅇㅆ다. TCNT는 1씩 오르니까!
  //  OCR1A = 900; //low(최소값)) : 그래프!!! 비교값 -> 주기 조정하는 값. 주기에 따라서   
